...
public class CalenderInfo {
	...
	public enum PROCESS{
		IN_PROGRESS,PROCESSED,CONFLICT,NOT_STARTED,RETRY,PAUSE,NOT_PROCESSED,METADATA_STARTED,METADATA_INPROGRESS,METADATA_CONFLICT;
		}
