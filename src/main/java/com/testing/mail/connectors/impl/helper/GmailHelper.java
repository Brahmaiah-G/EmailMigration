...
import com.testing.mail.connectors.google.data.AccessTokenRequest;
import com.testing.mail.connectors.google.data.AccessTokenResponse;
import com.testing.mail.connectors.google.data.Attachment;
import com.testing.mail.connectors.google.data.Attendee;
import com.testing.mail.connectors.google.data.Biography;
import com.testing.mail.connectors.google.data.Connection;
import com.testing.mail.connectors.google.data.EmailAddress;
...
import com.testing.mail.connectors.google.data.Header;
import com.testing.mail.connectors.google.data.Label;
import com.testing.mail.connectors.google.data.MailValue;
import com.testing.mail.connectors.google.data.Organization;
import com.testing.mail.connectors.google.data.Part;
import com.testing.mail.connectors.google.data.PhoneNumber;
...
import com.testing.mail.contacts.entities.Address;
...
import com.testing.mail.contacts.utils.CountryCodes;
...
public class GmailHelper {
	...
	public Contacts getContactsInfo( Connection eachConnection) {
		...
		if(eachConnection.getAddresses()!=null && !eachConnection.getAddresses().isEmpty()){
			List<com.testing.mail.contacts.entities.Address> addressList = new ArrayList<>();
			for (com.testing.mail.connectors.google.data.Address eachAddress : eachConnection.getAddresses()) {
				com.testing.mail.contacts.entities.Address address = new com.testing.mail.contacts.entities.Address();
